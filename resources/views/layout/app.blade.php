    ...
    <div class="row">
      <div class="col-md-3 col-sm-6">
        <div class="footer_panel bottom30">
          ...
          <p class="bottom15">If you are interested in RealtyHomes do not wait and <a href="javascript:void(0)">BUY IT NOW!</a></p>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="footer_panel bottom30">
          ...
          <ul class="getin_touch">
            ...
            <li><a href="javascript:void(0)"><i class="icon-icons142"></i>info@realtyhomes.com</a></li>
            <li><a href="javascript:void(0)"><i class="icon-browser2"></i>www.realtyhomes.com</a></li>
            <li><i class="icon-icons74"></i>Advisor Melbourne, Merrick Way,FL 12345 australia</li>
          </ul>
        </div>
      </div>
    </div>
